...
public class AddUserServiceImpl extends RemoteServiceServlet implements
	...
	@Override
	public AddUserService.InsertionResult addUser(String email,
			String password, String firstName, String lastName)
			throws IllegalArgumentException {

		try {
			// TODO add some code to guarantee that emails are unique so that
			// user accounts cannot be created twice
